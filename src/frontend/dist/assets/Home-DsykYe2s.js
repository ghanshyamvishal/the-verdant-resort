import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, L as Link } from "./index-CByRBKgt.js";
import { u as useIntersectionObserver, B as Button, L as Leaf } from "./ResortButton-DzWrBWsR.js";
import { W as Waves, S as Star } from "./waves-UIUouqHW.js";
import { r as rooms } from "./rooms-Eo8FehO-.js";
import { R as RoomCard, M as Mountain } from "./RoomCard-DF38i8pX.js";
...
function EnhancedAmenityCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: `card-3d card-shimmer flex gap-4 p-5 rounded-resort-lg group ${isVisible ? "animate-zoom-in opacity-init" : "opacity-0"}`,
      style: {
...
function AmenitiesSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12 items-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: amenities.map((amenity, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          EnhancedAmenityCard,
          {
            icon: amenity.icon,
            title: amenity.title,
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "linear-gradient(135deg, rgba(45,90,39,0.88) 0%, rgba(0,0,0,0.72) 50%, rgba(45,90,39,0.80) 100%)",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "radial-gradient(ellipse at center, rgba(242,201,76,0.12) 0%, transparent 65%)",
          ...
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-4 justify-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/check-availability", "data-ocid": "cta.book_stay_button", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "yellow", size: "lg", className: "shadow-lg", children: "Check Availability" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/rooms", "data-ocid": "cta.view_rooms_button", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
...
function WelcomeStrip() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      className: "section-padding",
      style: { backgroundColor: "var(--color-bg-secondary)" },
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: features.map(({ icon: Icon, title, desc, delay }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: `card-3d card-shimmer flex flex-col items-center text-center p-8 rounded-resort-lg ${isVisible ? "animate-zoom-in opacity-init" : "opacity-0"}`,
          style: {
            animationDelay: isVisible ? `${delay}ms` : "0ms",
            opacity: isVisible ? void 0 : 0
          },
...
function GoldenDivider() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-3 my-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
      ...
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: `text-center mb-4 transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12", children: featuredRooms.map((room, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(RoomCard, { room, index: i })
            },
            room.slug
          )) }),
      ...
      children: [
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  style: {
                    background: "linear-gradient(to bottom, rgba(0,0,0,0.46) 0%, rgba(0,0,0,0.28) 50%, rgba(0,0,0,0.72) 100%)"
                  }
                }
              )
            ]
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  style: {
                    ...
                    animation: "drawLine 0.6s ease-out 0.5s forwards, fadeInUp 0.5s ease-out 0.5s forwards"
                  }
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: slide.ctaPrimary.to, "data-ocid": "hero.explore_rooms_button", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "yellow", size: "lg", children: slide.ctaPrimary.label }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            onMouseEnter: (e) => {
              e.currentTarget.style.backgroundColor = "rgba(242,201,76,0.7)";
            },
            onMouseLeave: (e) => {
              e.currentTarget.style.backgroundColor = "rgba(255,255,255,0.15)";
            },
...
function EnhancedTestimonialCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "article",
    {
      className: `relative p-6 rounded-resort-lg transition-smooth ${floatAnim ? "animate-float" : ""} ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`,
      style: {
        background: "rgba(255,255,255,0.06)",
        border: "1px solid rgba(242,201,76,0.18)",
        backdropFilter: "blur(10px)",
        WebkitBackdropFilter: "blur(10px)",
        boxShadow: "0 2px 4px rgba(0,0,0,0.06), 0 8px 24px rgba(0,0,0,0.10), 0 20px 40px rgba(0,0,0,0.08)",
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1 mb-4 relative z-10", children: [1, 2, 3, 4, 5].map((star) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Star,
          {
            size: 14,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "absolute inset-0 pointer-events-none",
            style: {
              background: "radial-gradient(ellipse at 50% 0%, rgba(45,90,39,0.5) 0%, transparent 70%)"
            },
            "aria-hidden": "true"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 relative z-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: testimonials.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": `testimonials.item.${i + 1}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function GalleryGrid({ images, onImageClick }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4 auto-rows-[220px]", children: gridImages.map((img, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      type: "button",
...
function Lightbox({
  ...
  const [imgKey, setImgKey] = reactExports.useState(currentIndex);
  ...
  const handleTouchStart = (e) => {
    var _a;
    touchStartX.current = ((_a = e.touches[0]) == null ? void 0 : _a.clientX) ?? 0;
  };
  const handleTouchEnd = (e) => {
    var _a;
    const endX = ((_a = e.changedTouches[0]) == null ? void 0 : _a.clientX) ?? 0;
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
                  ...
                  alt: (image == null ? void 0 : image.alt) ?? "Gallery image",
                  style: {
                    maxWidth: "90vw",
                    maxHeight: "80vh",
                    objectFit: "contain",
                    ...
                    animation: "lightbox-zoom-in 0.3s cubic-bezier(0.34,1.56,0.64,1) forwards"
                  }
                },
                imgKey
              ),
              (image == null ? void 0 : image.title) && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
...
function GallerySection() {
  ...
  const showPrev = reactExports.useCallback(() => {
    setLightboxIndex(
      (prev) => prev === null ? null : (prev - 1 + galleryImages.length) % galleryImages.length
    );
  }, []);
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(GalleryGrid, { images: galleryImages, onImageClick: openLightbox })
            }
          )
        ] })
      }

import { c as createLucideIcon, j as jsxRuntimeExports, r as reactExports, L as Link, X } from "./index-zJLe_Wga.js";
import { u as useIntersectionObserver, L as Leaf } from "./useIntersectionObserver-BTVJ6liu.js";
import { B as Button } from "./ResortButton-DTDHb4Ia.js";
import { W as Waves, S as Star, C as ChevronDown } from "./waves-CLrUvUQb.js";
import { R as RoomCard, M as Mountain, r as rooms } from "./RoomCard-D_hoqT63.js";
/**
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  style: { color: "var(--color-text-secondary)" },
                  children: "From sunrise yoga on our mountain terrace to late-night stargazing by the campfire, The Verdant Resort offers a curated collection of world-class amenities designed to nourish your body, mind, and spirit. Every experience is crafted with care so you leave feeling truly restored."
                }
              ),
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "linear-gradient(135deg, rgba(28,44,30,0.82) 0%, rgba(0,0,0,0.68) 100%)"
            }
          }
        ),
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "Book your stay at The Verdant Resort and discover luxury redefined. Immerse yourself in nature's embrace with every comfort at your fingertips."
                }
              ),
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "absolute inset-0",
            style: {
              background: "linear-gradient(to bottom, rgba(0,0,0,0.45) 0%, rgba(0,0,0,0.3) 50%, rgba(0,0,0,0.65) 100%)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex flex-col items-center text-center px-4 max-w-4xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-heading font-bold text-5xl md:text-6xl lg:text-7xl text-white leading-tight mb-6", children: [
            "Where Nature",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "Nestled in the heart of nature, The Verdant Resort offers an unparalleled escape into luxury and tranquility. Experience the perfect harmony of forest, mountain, and five-star service."
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/rooms", "data-ocid": "hero.explore_rooms_button", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "filled", size: "lg", children: "Explore Rooms" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/about", "data-ocid": "hero.our_story_button", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
...
const testimonials = [
  ...
  {
    quote: "The Verdant Resort redefined luxury for us. Every detail — from the organic toiletries to the impeccable service — spoke of true excellence.",
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "Hear from the guests who have experienced the magic of The Verdant Resort first-hand"
                }
              )
            ]
          }
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  className: "font-body text-base max-w-xl mx-auto",
                  style: { color: "var(--color-text-secondary)" },
                  children: "A glimpse into the natural beauty and impeccable luxury that awaits you at The Verdant Resort"
                }
              )
            ]
          }

import { c as createLucideIcon, j as jsxRuntimeExports, L as Link } from "./index-zJLe_Wga.js";
/**
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const __iconNode$2 = [["path", { d: "m8 3 4 8 5-5 5 15H2L8 3z", key: "otkl63" }]];
const Mountain = createLucideIcon("mountain", __iconNode$2);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const rooms = [
  {
    ...
    type: "Deluxe",
    description: "Immerse yourself in nature with panoramic forest views and premium amenities in our most beloved room.",
  ...
  },
  {
    ...
    type: "Suite",
    description: "Commanding vistas of majestic peaks from a spacious suite with a separate living area and premium finishes.",
  ...
  },
  {
    ...
    type: "Villa",
    description: "Your own secluded sanctuary featuring a heated private infinity pool, butler service, and lush garden grounds.",
  ...
  },
  {
    ...
    name: "Family Cottage",
    type: "Family",
    description: "A charming countryside cottage with interconnected rooms, a private yard, and dedicated kids' amenities.",
  ...
  },
  {
    ...
    type: "Suite",
    description: "Crafted for romance — a secluded suite with flower petal turndown, champagne, and a private balcony Jacuzzi.",
  ...
  },
  {
    ...
    type: "Presidential",
    description: "The pinnacle of resort luxury — a 3,000 sq ft palace with panoramic views, private pool, and full butler staff.",

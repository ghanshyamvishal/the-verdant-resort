const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Home-DsykYe2s.js","assets/ResortButton-DzWrBWsR.js","assets/waves-UIUouqHW.js","assets/rooms-Eo8FehO-.js","assets/RoomCard-DF38i8pX.js","assets/chevron-down-Cal5SS26.js","assets/About-Cc1g26ec.js","assets/Rooms-Ch6ZBpgo.js","assets/RoomDetail-CdMoMbwI.js","assets/circle-check-B15DTQzx.js","assets/CheckAvailability-BQnwfRQS.js"])))=>i.map(i=>d[i]);
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "header",
      {
        ...
        style: {
          ...
          boxShadow: isScrolled ? "0 4px 32px rgba(0,0,0,0.35), 0 1px 0 rgba(242,201,76,0.12)" : "0 2px 16px rgba(0,0,0,0.18)",
                  ...
                  children: [
                      ...
                      Link,
                      {
                        ...
                        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "span",
                          {
                            ...
                            children: [
                              link.label,
                              isActive(link.to) && /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "span",
                                {
                                  style: {
                                    width: "6px",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      Link,
                      {
                        ...
                        children: [
                          "Check Availability",
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { opacity: 0.7, fontSize: "1rem" }, children: "→" })
                        ]
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
...
const Home = reactExports.lazy(
  () => __vitePreload(() => import("./Home-DsykYe2s.js"), true ? __vite__mapDeps([0,1,2,3,4,5]) : void 0).then((m) => ({ default: m.Home }))
);
const About = reactExports.lazy(
  () => __vitePreload(() => import("./About-Cc1g26ec.js"), true ? __vite__mapDeps([6,1]) : void 0).then((m) => ({ default: m.About }))
);
const Contact = reactExports.lazy(
  () => __vitePreload(() => import("./Contact-B0W5qHDs.js"), true ? [] : void 0).then((m) => ({ default: m.Contact }))
);
const Rooms = reactExports.lazy(
  () => __vitePreload(() => import("./Rooms-Ch6ZBpgo.js"), true ? __vite__mapDeps([7,4,3]) : void 0).then((m) => ({ default: m.Rooms }))
);
const RoomDetail = reactExports.lazy(
  () => __vitePreload(() => import("./RoomDetail-CdMoMbwI.js"), true ? __vite__mapDeps([8,4,3,9,2,5]) : void 0).then((m) => ({ default: m.RoomDetail }))
);
const CheckAvailability = reactExports.lazy(
  () => __vitePreload(() => import("./CheckAvailability-BQnwfRQS.js"), true ? __vite__mapDeps([10,3,5,9]) : void 0).then((m) => ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-16 md:h-20 shrink-0", "aria-hidden": "true" }),
...
function NotFound() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center min-h-[60vh] gap-6 text-center px-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "btn-3d px-6 py-3 text-sm", children: "Return Home" })
  ] });
}
...
const checkAvailabilityRoute = createRoute({
  ...
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(CheckAvailability, {}) })
});
